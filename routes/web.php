...
Route::get('/frontendcategories', [FrontendCategoryController::class, 'index'])->name('frontendcategories.index');
Route::get('frontendcategories/{category}', [FrontendCategoryController::class, 'show'])->name('frontendcategories.show');
